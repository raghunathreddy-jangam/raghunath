...
"""autogenerated by genpy from assignment/AddTwoIntsRequest.msg. Do not edit."""
import sys
...
class AddTwoIntsRequest(genpy.Message):
  ...
  _type = "assignment/AddTwoIntsRequest"
...
def _get_struct_2q():
    ...
    return _struct_2q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from assignment/AddTwoIntsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class AddTwoIntsResponse(genpy.Message):
  _md5sum = "f94c039fa857a4596a4abfc9a95f79f1"
  _type = "assignment/AddTwoIntsResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_qd().pack(_x.sum, _x.time))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.sum, _x.time,) = _get_struct_qd().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class AddTwoInts(object):
  _type          = 'assignment/AddTwoInts'
  _md5sum = '95fe1f9a1a908e906775b69d5fe39edf'
